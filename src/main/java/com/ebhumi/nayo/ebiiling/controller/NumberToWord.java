...
public class NumberToWord
{
    ...
    public String convertDecimlToWord(double number){
        ...
        int n = (int)number;
        return  convertNumberToWords(n) +" and "+ convertNumberToWords(Integer.parseInt(decimalPart)) +" Paise";
    ...
    public static void main(String[] args) {
        new NumberToWord().convertDecimlToWord(23.45);
    }
